...
def create_handoff_metadata(mdata, params_rna, params_atac):
    ...
    handoff_data = {
        ...
        "data_shapes": {
            ...
            "rna_connectivity": list(mdata["rna"].obsp["connectivities"].shape), # CHANGED NAME FROM CONN_RNA
            "atac_connectivity": list(mdata["atac"].obsp["connectivities"].shape) # CHANGED NAME FROM CONN_ATC
        },
        "next_steps": [
